...
export const augmentationGroups: Array<{
...
}> = [
  {
    id: 'mixing',
    title: 'Mixing',
    description: '두 샘플을 섞어 decision boundary를 더 부드럽고 탄탄하게 학습합니다.',
    options: [
      {
        id: 'mixup',
        label: 'MixUp',
  ...
  },
  {
    id: 'geometry',
    title: 'Geometric',
    description: '위치와 방향 변화에 덜 민감하도록 학습시킵니다.',
    options: [
      {
        id: 'random_crop',
        label: 'Random Crop',
  ...
  },
  {
    ...
    description: '조명, 채도, 대비가 달라도 핵심 특징을 잡게 합니다.',
    options: [
      {
        id: 'color_jitter',
        label: 'Color Jitter',
  ...
  },
  {
    id: 'tone',
    title: 'Tone Shift',
    description: '색이 줄어들어도 형태 중심으로 보게 만듭니다.',
    options: [
      {
        id: 'grayscale',
        label: 'Grayscale',
