...
const tutorialLessons: TutorialLesson[] = [
  ...
  },
  {
    ...
    paletteClass: 'bg-[#fff4ea] text-[#b95b16]',
    accentClassName: 'text-[#b95b16]',
    summary: '고장 난 자동 앨범 정리 시스템을 복구하기 위해, CIFAR-10 이미지 특징을 더 깊은 CNN으로 다시 읽어내는 스토리형 수업입니다.',
    bullets: [
      '자동 앨범 정리 AI가 동물과 탈것을 헷갈리는 상황에서 더 깊은 특징 추출기가 왜 필요한지 연결합니다.',
      'CIFAR-10처럼 색상과 배경이 복잡한 이미지에서 깊은 CNN이 계층적 특징을 쌓는 과정을 경험합니다.',
      '얕은 CNN보다 더 깊은 구조가 객체별 분류 안정성을 어떻게 끌어올리는지 바로 비교할 수 있습니다.',
    ],
  },
  {
    id: 'cnn-1-3',
